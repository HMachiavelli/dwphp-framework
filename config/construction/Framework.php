...
abstract class Framework
{
	...
	/*
	 *	construtor que recebe f e chama o metodo
	 *	initialize. Nao pode sofrer sobrecarga
	 */
	...
	/*
	 *	sub metodo construtor que pode ser sobrecarregado
	 *	na superclasse.
	 */
	...
	final public function constructPage()
	{
		...
		if (!file_exists($baseFiles)) {
			throw new \Exception("Nao encontrado: " . $f->getPathApplication('views/layout/', $f->template->getTemplate() . '/_init.php'));
		}
	...
	/*
			metodos que, por padrao, sao chamados no Template.
		*/
